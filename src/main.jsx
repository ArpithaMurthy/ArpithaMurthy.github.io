  ...
  return <div className="site-shell">
    ...
    {selectedArticle ? <main id="top" className="article-page"><a className="back-link" href="/#notes">← All notes</a><article className="article-shell"><p className="article-date">{selectedArticle.date}</p><div className="article-body" dangerouslySetInnerHTML={{ __html: renderArticle(selectedArticle.content) }} /></article></main> : <main id="top">
      <section className="hero section-grid" aria-labelledby="hero-title">
        <div className="hero-copy"><h1 id="hero-title">Hello, I’m <em>Arpitha.</em></h1><p className="hero-intro">After ten years in software, I’m starting a new chapter and sharing what I learn along the way.</p><div className="hero-actions"><a className="button button-primary" href={siteConfig.linkedin} target="_blank" rel="noreferrer">Let’s connect <ArrowUpRight size={17} /></a><a className="text-link" href="#notes">See what I’m learning <span>↓</span></a></div></div>
